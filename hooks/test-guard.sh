...
check block 'pass show example/prod'
check block 'pass example/prod'
check block 'pass -c github'
check block 'pass grep api_key'
check block 'cd /tmp && pass show example/prod'
check block 'echo ok; pass show example/prod'
check block 'true | pass insert example/prod'
check block '   pass show example/prod'
check block $'cd /tmp\npass show example/prod'
...
check allow 'rm -rf ~/projects/example/tmp/build-cache'
