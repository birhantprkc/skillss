...
check block 'gh api -X DELETE /repos/owner/repo'
check block 'gh api repos/owner/repo --method DELETE'
...
check block 'pass show example/service'
check block 'pass example/service'
check block 'pass -c github'
check block 'pass grep api_key'
check block 'cd /tmp && pass show example/service'
check block 'echo ok; pass show example/service'
check block 'true | pass insert example/service'
check block '   pass show example/service'
check block $'cd /tmp\npass show example/service'
check block 'op read op://Private/Example/token'
check block 'op item get Example --fields password'
...
check block 'cat ~/.password-store/example.gpg'
...
check allow 'gh repo clone owner/repo'
check allow 'gh api /repos/owner/repo'
...
check allow 'gh repo edit owner/repo --description "new desc"'
