...
`brand-example.com` (2026-07): internal team tool, domain contained a third-party brand name, anonymous visitors were redirected straight to a "Brand Example"-branded email+password form, plus a public waitlist form. Flagged as deceptive site; blocked in Brave/Chrome. Fix: deleted waitlist page, added neutral `/welcome` landing (ownership + non-affiliation notice), de-branded all logged-out pages, then Search Console review. Code was never the problem.
