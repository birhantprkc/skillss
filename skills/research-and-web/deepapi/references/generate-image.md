...
Generated endpoint reference for the `generate-image` rows of the `deepapi` skill router. Bundle version: a2fd8bb6e07b. This file is always managed — it is refreshed with the bundle even when `../SKILL.md` has been customized.
