...
Generated endpoint reference for the `generate-image` rows of the `deepapi` skill router. Bundle version: 0da3c1fcc437. This file is always managed — it is refreshed with the bundle even when `../SKILL.md` has been customized.
