...
Generated endpoint reference for the `manage-agent-state` rows of the `deepapi` skill router. Bundle version: 014fe6c78702. This file is always managed — it is refreshed with the bundle even when `../SKILL.md` has been customized.
