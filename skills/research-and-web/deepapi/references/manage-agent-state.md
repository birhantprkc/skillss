...
Generated endpoint reference for the `manage-agent-state` rows of the `deepapi` skill router. Bundle version: 2f20fd0d19a8. This file is always managed — it is refreshed with the bundle even when `../SKILL.md` has been customized.
