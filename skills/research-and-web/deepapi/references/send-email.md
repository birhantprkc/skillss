...
Generated endpoint reference for the `send-email` rows of the `deepapi` skill router. Bundle version: 00b181aa4f09. This file is always managed — it is refreshed with the bundle even when `../SKILL.md` has been customized.
