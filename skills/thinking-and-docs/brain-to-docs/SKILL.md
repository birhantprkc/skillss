---
name: brain-to-docs
description: Use when the user wants to extract project vision, decisions, and preferences from the user's head into clear documentation (README + ADRs) through a back-and-forth Q&A loop. Triggers on "brain-to-docs", "build out the docs", "extract the vision", "let's document this project".
---
