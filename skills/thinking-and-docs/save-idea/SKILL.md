...
- All idea capture was centralized into `~/ideas` on 2026-08-14 (the user's decision). The old `~/old-ideas-repo` repo is frozen pending archive — NEVER write or push there. Startup support material now lives in `~/ideas/startup/`.
