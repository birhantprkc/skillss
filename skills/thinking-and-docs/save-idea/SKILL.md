...
Capture one thing fast, then get out of the way. Five buckets, five files, ONE repo (`~/ideas`):
...
2. **Route it.**
   ...
   - Convictions have NO prefix (deliberate, user decision 2026-08-18) — route them by judgment only.
...
git -C ~/ideas add VIDEO-IDEAS.md TOPICS.md MARKETING-IDEAS.md STARTUP-IDEAS.md CONVICTIONS.md
...
- All idea capture was centralized into `~/ideas` on 2026-08-14 (the user's decision). The old startup repo is frozen pending archive — NEVER write or push there. Startup support material now lives in `~/ideas/startup/`.
